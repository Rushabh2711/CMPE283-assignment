...
// EDITION OF CODE FOR ASSIGNMENT - 2: *****************************************************
...
// EDITION OF CODE FOR ASSIGNMENT - 2: *****************************************************
extern atomic64_t totalNumOfExits;
extern atomic64_t totalAmountOfTime;
// END OF EDITION: *************************************************************************
...
static int vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	int ret;	
	u64 sTime = rdtsc();	
	atomic64_inc(&totalNumOfExits);	
	ret = __vmx_handle_exit(vcpu, exit_fastpath);	
	atomic64_add(rdtsc() - sTime, &totalAmountOfTime);
	// END OF EDITION CODE
